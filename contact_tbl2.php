...
<a class="second" href="contact_tbl1.php"><button class="btn btn-primary">Form1 Details</button></a>  
        </nav>
        </div>
        </header>
...
$sql = "SELECT client_id, name, email, address, category, birth_date, joining_date, message FROM gym_trainer";
...
<td><a href="delete2.php?record=<?php echo $row['client_id']; ?>"> Delete</a></td>
</tr>
