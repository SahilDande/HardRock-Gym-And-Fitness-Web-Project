...
$sql_query = "INSERT INTO gym_trainer (name,email,address,category,birth_date,joining_date,message)
VALUES ('$name','$email','$address','$category','$birth_date','$joining_date','$message')";
